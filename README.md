...
👨‍🎓 **Student:** Information Technology at Saigon University.

🎯 **Current Goal:** Seeking **Backend Engineering Internship** (Node.js / Python).

🌱 **Future Path:** Transitioning to **Go** to master **Cloud Native** technologies.

🧠 **Passion:** * Solving algorithmic problems (Competitive Programming).
* Turning caffeine into clean, scalable code ☕.

🤝 **Open to collaborate on:** Backend systems, API design, and Open Source projects.
...
[![My Skills](https://skillicons.dev/icons?i=cpp,py,ts,go,latex)](https://skillicons.dev)

### 🚀 Backend Frameworks
[![My Skills](https://skillicons.dev/icons?i=nodejs,express,fastapi)](https://skillicons.dev)

### ☁️ Cloud & DevOps (Learning Journey)
[![My Skills](https://skillicons.dev/icons?i=docker,aws,ubuntu)](https://skillicons.dev)

### 🗄️ Database
[![My Skills](https://skillicons.dev/icons?i=postgres,mysql,supabase)](https://skillicons.dev)
